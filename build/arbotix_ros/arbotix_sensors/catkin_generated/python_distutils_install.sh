...
echo_and_run cd "/home/fan/autolabor/src/arbotix_ros/arbotix_sensors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/fan/autolabor/src/arbotix_ros/arbotix_sensors/setup.py" \
    build --build-base "/home/fan/autolabor/build/arbotix_ros/arbotix_sensors" \
    install \
    $DESTDIR_ARG \
